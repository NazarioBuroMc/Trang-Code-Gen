...
import com.codegen.relaxng.edit.PatternVisitor;
...
import com.codegen.relaxng.output.common.NameClassSplitter;
...
import com.codegen.relaxng.output.xsd.basic.AttributeUseChoice;
...
public class BasicBuilder {
  ...
  static private final String GUIDE_NAMESPACE = "http://www.codegen.com/ns/relaxng/xsd";
  ...
  private static void copyComments(List fromList, List toList) {
    for (Iterator iter = fromList.iterator(); iter.hasNext();) {
      ...
      if (obj instanceof Comment) {
        Comment comment = (Comment)obj;
        toList.add(new com.codegen.relaxng.output.xsd.basic.Comment(comment.getSourceLocation(),
                                                                           comment.getValue()));
      }
    }
  }
