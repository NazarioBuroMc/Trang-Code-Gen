...
import com.codegen.relaxng.output.xsd.basic.Definition;
...
import com.codegen.relaxng.output.xsd.basic.Include;
      ...
      for (Iterator iter = namespaceUsageMap.entrySet().iterator(); iter.hasNext();) {
        ...
        if (best == null
            ...
            || (tem.getValue().equals(best.getValue())
                && ((String)tem.getKey()).compareTo(String.valueOf(best.getKey())) < 0))
          best = tem;
      }
