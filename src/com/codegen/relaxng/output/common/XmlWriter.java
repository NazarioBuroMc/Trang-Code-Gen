...
public class XmlWriter {
  ...
  public XmlWriter(Writer w, String encoding, CharRepertoire cr, String lineSep, int indent, String[] topLevelAttributes) {
     ...
     * Header XSD
     */
    ResourceBundle messages = ResourceBundle.getBundle(WellKnownNamespaces.ROOT_PROPERTIES_MESSAGE);
    write(messages.getString(WellKnownNamespaces.MESSAGE_ONE));
    write(messages.getString(WellKnownNamespaces.MESSAGE_TWO));
    write(messages.getString(WellKnownNamespaces.MESSAGE_THREE));
    write(messages.getString(WellKnownNamespaces.MESSAGE_FOUR));
    write(messages.getString(WellKnownNamespaces.MESSAGE_FIVE));
    write(messages.getString(WellKnownNamespaces.MESSAGE_SIX_A) + String.valueOf(new Date() + WellKnownNamespaces.SPACE) + messages.getString(WellKnownNamespaces.MESSAGE_SIX_B));
    write(messages.getString(WellKnownNamespaces.MESSAGE_SEVEN));
    write(messages.getString(WellKnownNamespaces.MESSAGE_EIGHT));
    write(messages.getString(WellKnownNamespaces.MESSAGE_NINE));
    write(messages.getString(WellKnownNamespaces.MESSAGE_TEN));
    write(messages.getString(WellKnownNamespaces.MESSAGE_ELEVEN));
  }
